...
/** @type {string} */
const CACHE_VERSION = '1769965620|2199565274';
/** @type {string} */
const CACHE_PREFIX = 'Fish Out of Wate-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'fish-out-of-water.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["fish-out-of-water.html","fish-out-of-water.js","fish-out-of-water.offline.html","fish-out-of-water.icon.png","fish-out-of-water.apple-touch-icon.png","fish-out-of-water.audio.worklet.js","fish-out-of-water.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["fish-out-of-water.wasm","fish-out-of-water.pck"];
